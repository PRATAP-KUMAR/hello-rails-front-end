...
**Hello Rails React** is about setting up "Hello world" project with two apps
...
````
git clone https://github.com/PRATAP-KUMAR/hello-rails-front-end
...
- **What is this repo for**
  ...
  - Its part of Microverse Currculum for Setting up Hello-Rails-Front-End Project
